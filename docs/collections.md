...
| `moments` | Rubric-driven moments discovered across every current and future member | Search (`moment` scope), moment & finding enumeration, Responses API (entity-backed with nimbus-002-preview, incl. moments-only knowledge bases) — see [Find Moments](./find-moments.md) |
